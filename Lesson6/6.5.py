...
class Pen(Stationary):
    ...
    def draw(self):
        return f'Предмет:{self.title}. Запуск отрисовки ручкой'
...
class Pencil(Stationary):
    ...
    def draw(self):
        return f'Предмет:{self.title}. Запуск отрисовки карандашом'
...
class Handle(Stationary):
    ...
    def draw(self):
        return f'Предмет:{self.title}. Запуск отрисовки маркером'
